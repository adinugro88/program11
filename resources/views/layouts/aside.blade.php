 ...
 <aside class="sidebar-wrapper">
     ...
     <div class="sidebar-nav" data-simplebar="true">
         ...
         <ul class="metismenu" id="menu">
             ...
             <li>
                 <a href="javascript:;" class="has-arrow">
                     <div class="parent-icon"><span
                             class="material-symbols-outlined @if (Request::is('karyawan/*')) active @endif">widgets</span>
                     </div>
                 ...
                 <ul>
                     ...
                     <li> <a href="/karyawan/create"><span class="material-symbols-outlined">arrow_right</span>Karyawan
                             baru </a>
                     </li>
                 </ul>
             </li>
             ...
             <li>
                 <a href="javascript:;" class="has-arrow">
                     <div class="parent-icon"><span
                             class="material-symbols-outlined @if (Request::is('gajian/*')) active @endif">widgets</span>
                     </div>
                     <div class="menu-title">Gajian</div>
                 </a>
                 <ul>
                     <li> <a href="/gajian"><span class="material-symbols-outlined">arrow_right</span>All Data </a>
                     </li>
                     <li> <a href="/gajian/create"><span class="material-symbols-outlined">arrow_right</span>Gajian
                             baru </a>
                     </li>
                 </ul>
             </li>
             ...
             <li>
                 ...
                 <ul>
                     <li> <a href="icons-line-icons.html"><span class="material-symbols-outlined">arrow_right</span>Line
                             Icons</a>
                     </li>
             ...
             <li>
                 ...
                 <ul>
                     <li> <a href="form-elements.html"><span class="material-symbols-outlined">arrow_right</span>Form
                             Elements</a>
                     </li>
                     ...
                     <li> <a href="form-layouts.html"><span class="material-symbols-outlined">arrow_right</span>Forms
                             Layouts</a>
                     </li>
                     ...
                     <li> <a href="form-repeater.html"><span class="material-symbols-outlined">arrow_right</span>Form
                             Repeater</a>
                     </li>
                 </ul>
             </li>
                     ...
                     <li><a class="has-arrow" href="javascript:;"><span
                         ...
                         <ul>
                             ...
                             <li><a href="auth-basic-forgot-password.html" target="_blank"><span
                                         class="material-symbols-outlined">arrow_right</span>Forgot Password</a></li>
     ...
     <div class="sidebar-bottom dropdown dropup-center dropup">
         ...
         <ul class="dropdown-menu dropdown-menu-end">
             ...
             <li><a class="dropdown-item" href="/dashboard"><span class="material-symbols-outlined me-2">
                         dashboard
